...
/**
 * Dados dos números enteros y un operando aritmético, devuelve el resultado de la expresión
...
/**
 * Dados dos números reales y un operando aritmético, devuelve el resultado de la expresión
 * "num1 op num2" dentro de res. Además si la operación no es válida devuelve 0, o 1 en
 * caso de que si sea correcta.
 */
...
/**
 * Dados dos números enteros y un operando relacional, devuelve el resultado de la expresión
 * "num1 op num2".
 */
int intRelationalOperations(int num1, char *op, int num2);

/**
 * Dados dos números reales y un operando relacional, devuelve el resultado de la expresión
 * "num1 op num2".
 */
